    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <button className="text-sm font-semibold leading-6 text-gray-900" onClick={() => handleNotesListClick()}>
            My notes
          </button>
          <button className="text-sm font-semibold leading-6 text-gray-900" onClick={() => handleArchiveClick()}>
            Archive
          </button>
        </Popover.Group>
      </nav>
